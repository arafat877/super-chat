    ...
    <div className="appContainer">
      <div className="appWrapper">
        ...
        <div className="conversationsColumn">
          ...
          <div className="ccSelection">
            <ul className="ccSelectionList">
              <li className="ccSelectionListItem">All Chat</li>
              <li className="ccSelectionListItem">Private</li>
              <li className="ccSelectionListItem">Groups</li>
            </ul>
          </div>
