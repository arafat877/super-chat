    ...
    <Container className={classes.container}>
      <Grid container containerer className={classes.innerContainer}>
        <Grid item container className={classes.column1} xs={1}>
          <Grid item direction="column-reverse" className={classes.c1Logo} xs={12}>
            as
          </Grid>
          <Grid item direction="column-reverse" className={classes.c1Menu} xs={12}>
            as
          </Grid>
          <Grid item direction="column-reverse" className={classes.c1PP} xs={12}>
            as
          </Grid>
        </Grid>
