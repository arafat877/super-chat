    ...
    <Container className={classes.container}>
      <Grid container containerer className={classes.innerContainer}>
        ...
        <Grid item className={classes.column3} xs={8}>
          ...
          <Grid item className={classes.c3Input} xs={12}>
            <Grid item className={classes.inputEmoji} xs={8}>
              input
            </Grid>
            <Grid item className={classes.inputText} xs={8}>
              input
            </Grid>
            <Grid item className={classes.inputSend} xs={4}>
              input
            </Grid>
          </Grid>
        </Grid>
