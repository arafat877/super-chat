          ...
          <div className="col-md-1 container h-100 border firstCol">
            ...
            <div className="row border menuRow">
              <ul className="list-group">
                <li><AccountBalance className="menuItems"/></li>
                <li><Chat className="menuItems"/></li>
                <li><Person className="menuItems"/></li>
                <li><Palette className="menuItems"/></li>
                <li><Settings className="menuItems"/></li>
              </ul>
            </div>
