...
import "./App.scss";
import { Email, Chat, Person, Settings, Palette, AccountBalance } from '@material-ui/icons';
          ...
          <div className="col-md-1 container h-100 border firstCol">
            ...
            <div className="row border menuRow">
              <ul className="list-group">
                <li className="list-group-item"><AccountBalance className="menuItems"/></li>
                <li className="list-group-item"><Chat className="menuItems"/></li>
                <li className="list-group-item"><Person className="menuItems"/></li>
                <li className="list-group-item"><Palette className="menuItems"/></li>
                <li className="list-group-item"><Settings className="menuItems"/></li>
              </ul>
            </div>
