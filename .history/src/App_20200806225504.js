        ...
        <div className="row h-100">
          ...
          <div className="col-md-3 container h-100 secondCol">
            ...
            <div className="row selectRow">
              <ul className="selectionList list-group-horizontal">
                <li className="selectionListItem d-inline">All Chat</li>
                <li className="selectionListItem d-inline">Private</li>
                <li className="selectionListItem">Groups</li>
              </ul>
            </div>
