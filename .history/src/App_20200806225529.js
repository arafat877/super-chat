          ...
          <div className="col-md-3 container h-100 secondCol">
            ...
            <div className="row selectRow">
              <ul className="selectionList">
                <li className="selectionListItem d-inline mr-2">All Chat</li>
                <li className="selectionListItem d-inline mr-2">Private</li>
                <li className="selectionListItem d-inline mr-2">Groups</li>
              </ul>
            </div>
