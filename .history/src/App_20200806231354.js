        ...
        <div className="row h-100">
          ...
          <div className="col-3 container h-100 secondCol">
            ...
            <div className="row groupsRow">
              <div>
                <img className="userProfilePicture" src={require("./assets/m1.jpeg")} alt="User Profile"/>
                <span className="userName">Adam Brown</span>
                <span className="chatDate">2 days ago</span>
                <hr></hr>
                dsaaskdjaslk
              </div>
            </div>
