          ...
          <div className="col-3 container h-100 secondCol p-4">
            ...
            <div className="row groupsRow">
              <div className="container">
                <div className="row convCard pt-3 pb-3 pl-2 mb-3">
                  <img
                  ...
                  <span className="chatDate ml-2">Today</span>
                  <hr className="hr"></hr>
                  <span className="text">Hey man whatup?</span>
                </div>

                <div className="row convCardHot pt-4 pb-3 pl-2 mb-3">
                  <img
                    className="userProfilePicture"
                ...
                <div className="row convCardGroup pt-3 pb-3 pl-2 mb-3">
                  <img
                    className="userProfilePicture"
                ...
                <div className="row convCard pt-3 pb-3 pl-2 mb-3">
                  <img
                    ...
                    alt="User Profile"
                  />
                  <span className="userName ml-2">Eric Geller</span>
                  <span className="dash ml-2">-</span>
                  <span className="chatDate ml-2">3 days ago</span>
                  <hr className="hr"></hr>
                  <span className="text">
                    I had to rewind that magic trick about 10 times. It made my
                    day, thank you :D
                  </span>
                </div>
              </div>
