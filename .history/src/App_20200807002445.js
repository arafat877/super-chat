  ...
  return (
    <div className="appContainer vh-100 d-flex">
      <div className="container mt-3 mb-3 appWrapper">
            ...
            <div className="row groupsRow">
              <div className="container">
                <div className="row convCard pt-3 pb-3 pl-2 mt-3">
                  ...
                  <hr className="hr"></hr>
                  <span className="text">Hey man whatup?</span>
                </div>
        ...
        <img className="avatar rounded-circle" alt="Image placeholder" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/theme/team-1.jpg"/>
        <img className="avatar rounded-circle" alt="Image placeholder" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/theme/team-2.jpg"/>
        <img className="avatar rounded-circle" alt="Image placeholder" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/theme/team-3.jpg"/>
        <img className="avatar rounded-circle" alt="Image placeholder" src="https://demos.creative-tim.com/argon-dashboard-pro/assets/img/theme/team-4.jpg"/>
</div>
                </div>
              </div>
            </div>
