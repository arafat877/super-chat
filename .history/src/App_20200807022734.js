        ...
        <div className="row h-100">
          ...
          <div className="col-8 container h-100 thirdCol">
            ...
            <div className="row chatMessages">
              <div className="container">
                {/* MessageRow */}
                <div className="row messageRow ml-0 mt-3">
                  <div className="col-1">
                    <img
                      className="messageUserProfilePicture mb-auto"
                      src={require("./assets/f1.jpeg")}
                      alt="User Profile"
                    />
                  </div>
                  <div className="col-5 ml-0 text p-2">
                ...
                <div className="row messageRowOwner mr-0 mt-3">
                  <div className="col-5 offset-6 text p-2">
                ...
                {/* MessageRow */}
                <div className="row messageRow ml-1 mt-3">
                  <img
                    className="messageUserProfilePicture mb-auto mr-2"
                    src={require("./assets/f1.jpeg")}
                    alt="User Profile"
                  />
                  <div className="text p-2">Yas okay!</div>
                </div>
                {/* MessageRow */}
                <div className="row messageRowOwner mr-0 mt-3">
                  <div className="col-5 offset-6 text p-2">
