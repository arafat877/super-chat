...
const Conversations = ({ currentUser }) => {
  ...
  let aq = getPrivateConversations(currentUser._id,setPrivateConversations,dispatch)
  // useEffect(() => {
  //    aq = getPrivateConversations(currentUser._id,setPrivateConversations,dispatch)
  // }, []);
