...
const Conversations = ({ currentUser }) => {
  ...
  const { conversations,isFetching, error, dispatch } = useContext(ConversationContext);

  useEffect(() => {
    getPrivateConversations(currentUser._id,setPrivateConversations,dispatch)
    setPrivateConversations(conversations.privateConversations.conversations)
  }, []);
  
console.log(conversations.privateConversations.conversations)
  return (
