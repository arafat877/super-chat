      ...
      <div className="row selectRow mb-1">
        <ul className="selectionList pl-0">
          <li
            ...
            style= {selectedConversation === allConversations ? { borderBottom: "solid 0.05px #3576ef" } : {}}
          ...
          <li
            ...
            style= {selectedConversation === privateConversations ? { borderBottom: "solid 0.05px #3576ef" } : {}}
          ...
          <li
            className="selectionListItem d-inline mr-2 ml-2"
            style= {selectedConversation === groupConversations ? { borderBottom: "solid 0.05px #3576ef" } : {}}
