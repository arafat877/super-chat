...
const Conversations = ({ currentUser }) => {
  ...
  return (
    <>
        ...
        <div className="row selectRow mb-1">
          <ul className="selectionList pl-0">
            <li
              ...
              style={
                selectedConversation === allConversations
                  ? { borderBottom: "solid 0.05px #3576ef" }
                  : {}
              }
            ...
            <li
              ...
              style={
                selectedConversation === privateConversations
                  ? { borderBottom: "solid 0.05px #3576ef" }
                  : {}
              }
          ...
          <div className="container">
            ...
            {selectedConversation.map((a) =>
              a.adminUserId ? (
                ...
                <div
                  className="row convCard pt-3 pb-3 pl-2 mt-3"
                  key={a._id}
                  onClick={() => setGroupId(a._id)}
                >
                  <div className="container">
      ...
      <ChatBox currentUser={currentUser} groupId={groupId}/>
    </>
  );
};
