    ...
    <div className="appContainer vh-100 d-flex">
      <div className="container mt-3 mb-3 appWrapper">
        <div className="row h-100">
          ...
          <div className="col-md-3 col-sm-5 col-xs-12 container h-100 secondCol p-4">
          ...
          <div className="col-md-7 col-sm-7 col-xs-12 container h-100 thirdCol">
          ...
          <div className="d-none d-sm-none d-md-block col-1 container h-100 fourthCol">
            <div className="row logoRow justify-content-center">
